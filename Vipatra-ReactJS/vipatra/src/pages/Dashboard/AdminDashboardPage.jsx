...
const AdminDashboardPage = () => {
    ...
    // The component now ONLY returns the content that goes inside the <main> area.
    // The outer <Header>, <Sidebar>, <main>, and <Footer> have been removed.
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <section>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <Link to="/invoices" className="text-sm font-sans text-secondary hover:text-accent">{t('viewAll', 'View All')}</Link>
                        </div>
                ...
                <aside className="lg:col-span-1 space-y-8">
                    <section>
                        ...
                        <div className="dashboard-card space-y-4">
                            ...
                            <Link to="/inventory" className="block text-center text-sm font-sans text-secondary hover:text-accent pt-2">{t('dashboard.manageFullInventory', 'Manage Full Inventory')}</Link>
                        </div>
                    </section>
                </aside>
            </div>
