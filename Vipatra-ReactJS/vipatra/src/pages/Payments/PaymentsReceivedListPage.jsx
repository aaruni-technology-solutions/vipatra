...
const PaymentsReceivedListPage = () => {
    ...
    const pageStyles = `
      .page-container {
        ...
        background-color: #f9fafb; /* Assuming a light gray background like other pages */
      }
      .fixed-action-header {
        flex-shrink: 0;
        position: sticky;
        ...
        padding: 1.5rem 2rem 0; /* Original padding: p-6 sm:p-8, but no bottom padding */
      }
    ...
    return (
        <div className="page-container">
            ...
            <header className="fixed-action-header">
            ...
            <main className="scrollable-main-content">
                {/* The table view for Payments Received starts here */}
