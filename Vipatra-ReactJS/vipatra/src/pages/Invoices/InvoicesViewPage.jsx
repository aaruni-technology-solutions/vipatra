    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-1 overflow-hidden">
                <Sidebar /> {/* Ensure correct active link */}
                <main className="flex-1 p-6 sm:p-8 overflow-y-auto">
                    ...
                    <section className="mb-8 flex flex-wrap gap-3 items-center">
                        ...
                        <button className="font-sans text-sm bg-danger-DEFAULT hover:bg-danger-dark text-textOnPrimary px-4 py-2 rounded-lg shadow-soft flex items-center space-x-2">
