...
const CustomerViewPage = () => {
    ...
    if (!customer) {
        return (
            <div className="flex flex-col min-h-screen"><Header /><div className="flex flex-1 items-center justify-center"><p>{t('common.loading', 'Loading customer details...')}</p></div><Footer /></div>
        );
    }
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-1 overflow-hidden">
                <Sidebar /> {/* Ensure "Customers" link is active in the main sidebar */}
